...
<template>
  <aside class="fixed left-0 top-0 z-40 h-screen w-64 transform transition-transform bg-white dark:bg-dark-surface border-r border-gray-200 dark:border-dark-border sm:translate-x-0">
    <div class="h-full px-3 py-4 overflow-y-auto">
      ...
      <div class="absolute bottom-4 left-0 w-full px-3">
        <button class="flex w-full items-center p-3 text-gray-900 dark:text-gray-300 rounded-lg hover:bg-red-50 hover:text-red-600 dark:hover:bg-red-900/20 dark:hover:text-red-400 transition-colors">
